import { MapPin, Mountain, Users, ClipboardList, Lightbulb, CheckCircle, TrendingUp, Leaf } from "lucide-react";
...
export default function DoonGuidePoster() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-gray-100 p-4 md:p-8">
      ...
      <div className="max-w-6xl mx-auto bg-white shadow-2xl" style={{
        backgroundImage: 'repeating-linear-gradient(90deg, rgba(0,0,0,0.01) 0px, rgba(0,0,0,0.01) 1px, transparent 1px, transparent 2px)',
        position: 'relative'
      }}>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-4">
            ...
            <div className="flex-1 text-center">
              ...
              <p className="text-xs md:text-sm text-doon-gray font-nunito leading-relaxed">
                Smart travel & lifestyle companion for tourists and locals in Dehradun, Uttarakhand.
              </p>
            </div>
        ...
        <div className="border-b-4 border-dashed border-gray-300">
          ...
          <p className="font-nunito text-sm leading-relaxed text-doon-gray p-6 md:p-8">
            The project aims to create an integrated digital guide for Dehradun and nearby Uttarakhand regions. <span className="font-bold text-primary">Doon-Guide</span> simplifies exploration for tourists and locals by combining navigation, heritage insights, food & stay suggestions, and real-time travel assistance. It leverages geolocation-based recommendations and a community-driven review system to connect users with <span className="font-bold text-primary">authentic local experiences</span>.
          </p>
        </div>
          ...
          <div className="p-6 md:p-8 bg-gradient-to-br from-slate-50 to-gray-100">
            <div className="relative h-96 md:h-96 flex items-center justify-center mb-6">
              ...
              <div className="absolute inset-0 flex items-center justify-center" style={{ perspective: '1200px' }}>
                {[
                  { title: 'Home Screen', img: 'https://cdn.builder.io/api/v1/image/assets%2F00974640ca8c40aa9cc4806fcc2a0b70%2F71ec9fef3b364e91886ffa30df3e3edf?format=webp&width=800', transform: 'translateX(-120px) translateY(-40px) rotateY(15deg) rotateX(-8deg)' },
                  { title: 'Popular Guides', img: 'https://cdn.builder.io/api/v1/image/assets%2F00974640ca8c40aa9cc4806fcc2a0b70%2F1525675367bd4869a7bd74356c9575db?format=webp&width=800', transform: 'translateZ(40px) scale(1.05)' },
                  { title: 'Guide Details', img: 'https://cdn.builder.io/api/v1/image/assets%2F00974640ca8c40aa9cc4806fcc2a0b70%2Fc25f23c06d184e77a810b831253eab60?format=webp&width=800', transform: 'translateX(120px) translateY(40px) rotateY(-15deg) rotateX(8deg)' },
                ].map((screen, idx) => (
                  <div 
                    key={idx}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 mt-8">
              {[
                { title: 'Home Screen – Explore', img: 'https://cdn.builder.io/api/v1/image/assets%2F00974640ca8c40aa9cc4806fcc2a0b70%2F71ec9fef3b364e91886ffa30df3e3edf?format=webp&width=800' },
                ...
                { title: 'Explore Dehradun', img: 'https://cdn.builder.io/api/v1/image/assets%2F00974640ca8c40aa9cc4806fcc2a0b70%2F8c9197c55dd64a4a9de103b0e72a545e?format=webp&width=800' },
                { title: 'Weekend Trips', img: 'https://cdn.builder.io/api/v1/image/assets%2F00974640ca8c40aa9cc4806fcc2a0b70%2F71ec9fef3b364e91886ffa30df3e3edf?format=webp&width=800' },
                ...
                <div key={idx} className="bg-white rounded-lg border-2 border-primary overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <img src={screen.img} alt={screen.title} className="w-full aspect-video object-cover" />
                  <p className="font-nunito font-semibold text-xs md:text-sm text-primary p-2 text-center">{screen.title}</p>
                </div>
              ))}
            </div>

            <p className="text-center text-xs text-doon-gray font-inter italic mt-6">Designed in Figma – Responsive Web & Mobile</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 border-b-4 border-dashed border-gray-300">
          ...
          <div className="border-r-4 border-dashed border-gray-300 lg:border-r-4 lg:border-b-0">
            ...
            <div className="p-6 md:p-8 space-y-4">
              ...
              {[
                ...
                { icon: ClipboardList, label: 'Define', desc: 'Pain points and user needs analysis' },
                { icon: Lightbulb, label: 'Ideate', desc: 'Integrated guide platform concept' },
                { icon: MapPin, label: 'Wireframe', desc: 'Lo-fi layouts for navigation' },
                { icon: TrendingUp, label: 'Prototype', desc: 'Responsive mockups in Figma' },
                { icon: CheckCircle, label: 'Test & Refine', desc: 'User feedback from students' },
              ].map((item, idx) => {
                ...
                return (
                  <div key={idx} className="flex gap-3 items-start">
                    ...
                    <div>
                      <p className="font-poppins font-semibold text-xs text-orange-600">{item.label}</p>
          ...
          <div>
            ...
            <div className="p-6 md:p-8 space-y-5">
              {/* Primary Research */}
              <div>
                <h4 className="font-poppins font-bold text-xs text-orange-600 mb-3">Primary Research Highlights</h4>
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={idx} className="flex gap-2 font-nunito text-xs text-doon-gray">
              ...
              {/* Secondary Research */}
              <div>
                <h4 className="font-poppins font-bold text-xs text-orange-600 mb-3">Secondary Research Highlights</h4>
                <ul className="space-y-2">
                  {[
